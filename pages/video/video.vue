...
export default {
  ...
  methods: {
    ...
    updateDisplayList() {
      const prev = this.videoList[this.currentIndex - 1] || { id: 'empty_prev', videoSrc: '' }
      const curr = this.videoList[this.currentIndex]
      const next = this.videoList[this.currentIndex + 1] || { id: 'empty_next', videoSrc: '' }
